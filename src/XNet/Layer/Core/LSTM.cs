...
{
    public class LSTM : Layer.Utility.Layer
    {
        public int NeuronCount { get; private set; }

        public LSTM(int neuronCount, int index, Activation.Utility.ActivationSettings activationSettings) : base(neuronCount, index, activationSettings)
        {

...
{
    public class Dropout : Layer.Utility.Layer
    {
        public int NeuronCount { get; private set; }

        public Dropout(int neuronCount, int index, Activation.Utility.ActivationSettings activationSettings) : base(neuronCount, index, activationSettings)
        {
